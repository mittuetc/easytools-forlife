...
import {
  ...
  useCallbackRef,
  useFocusGuards
} from "./chunk-XZMIXAHT.js";
import {
  createCollection,
  useDirection
} from "./chunk-KKFIJIQO.js";
import {
  Presence,
  Primitive,
  ...
  useId,
  useLayoutEffect2
} from "./chunk-YVVHURWR.js";
import {
  createSlot,
  useComposedRefs
} from "./chunk-GI2LQ6CX.js";
import {
  require_react_dom
} from "./chunk-UAD7S5IU.js";
import {
  require_jsx_runtime
} from "./chunk-RSXNQI6F.js";
import {
  require_react
...
function SelectProvider(props) {
  ...
  const handleNativeOptionAdd = React7.useCallback((option) => {
    setNativeOptionsSet((prev) => new Set(prev).add(option));
  }, []);
  const handleNativeOptionRemove = React7.useCallback((option) => {
  ...
  return (0, import_jsx_runtime4.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime4.jsx)(SelectProviderImpl, { scope: __scopeSelect, ...context, children: (0, import_jsx_runtime4.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime4.jsx)(
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime4.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime4.jsx)(React7.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }
);
...
var SelectPortal = (props) => {
  ...
  return (0, import_jsx_runtime4.jsx)(PortalProvider, { scope: props.__scopeSelect, forceMount, children: (0, import_jsx_runtime4.jsx)(Portal, { asChild: true, ...portalProps }) });
};
...
var SelectContent = React7.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime4.jsx)(Presence, { present: forceMount || context.open, children: ({ present }) => present ? (0, import_jsx_runtime4.jsx)(SelectContentImpl, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime4.jsx)(SelectContentFragment, { ...contentProps, fragment }) });
  }
);
SelectContent.displayName = CONTENT_NAME2;
var SelectContentFragment = React7.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, children, fragment } = props;
  if (!fragment) return null;
  return ReactDOM2.createPortal(
    (0, import_jsx_runtime4.jsx)(SelectContentProvider, { scope: __scopeSelect, children: (0, import_jsx_runtime4.jsx)(Collection.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime4.jsx)("div", { ref: forwardedRef, children }) }) }),
    fragment
  );
});
...
var SelectItemText = React7.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      ...
      itemContext.isSelected && context.valueNode && !context.valueNodeHasChildren && !shouldShowPlaceholder(context.value) ? ReactDOM2.createPortal(itemTextProps.children, context.valueNode) : null
    ] });
  }
);
...
var SelectArrow = React7.forwardRef(
  (props, forwardedRef) => {
    ...
    return contentContext.position === "popper" ? (0, import_jsx_runtime4.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
  ...
  ({ __scopeSelect, ...props }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime4.jsxs)(
      Primitive.select,
      {
        ...
        children: [
          shouldShowPlaceholder(value) && !hasEmptyValueOption ? (0, import_jsx_runtime4.jsx)("option", { value: "" }) : null,
