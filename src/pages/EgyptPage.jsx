...
export default function EgyptPage() {
  const civilization = timeTravelersData.civilizations.find(c => c.id === 'egypt');
    ...
    <div className="min-h-screen bg-parchment-pattern">
      ...
      <section className="relative pt-24 pb-32 overflow-hidden border-b-4 border-gold/40">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-[hsl(var(--egypt-accent))]/10 mix-blend-overlay" />
        </div>
      ...
      <main className="container max-w-7xl mx-auto px-4 py-16">
        ...
        {filteredFacts.length > 0 ? (
          ...
          <div className="text-center py-24 bg-white/40 rounded-3xl border-2 border-dashed border-gold/40">
            ...
            <p className="text-ancient-brown/70">Try searching for something else like "Pyramid" or "Nile".</p>
          </div>
        )}
      </main>
      ...
      <section className="py-20 md:py-28 bg-white/50 backdrop-blur-sm border-t border-gold/20">
        <div className="container max-w-4xl mx-auto px-4">
          <h1 className="font-bangers text-4xl md:text-5xl text-ancient-brown mb-8 tracking-wide">
            Ancient Egypt for Kids — Pharaohs, Pyramids & Mummies
          </h1>
          
          <div className="prose prose-lg max-w-none text-ancient-brown/80 space-y-6">
            <p className="text-lg leading-relaxed">
              Welcome to the fascinating world of Ancient Egypt! Discover one of the world's greatest civilizations that thrived along the Nile River for thousands of years. From towering pyramids to mysterious mummies, Ancient Egypt is full of incredible discoveries that continue to amaze us today.
            </p>

            <div>
              <h3 className="font-bangers text-2xl text-ancient-brown mb-4 tracking-wide">What You'll Learn About Ancient Egypt:</h3>
              <ul className="space-y-3 list-none pl-0">
                <li className="flex items-start text-lg">
                  <span className="mr-3 text-2xl">👑</span>
                  <span><strong>Pharaohs</strong> — The powerful kings and queens who ruled Egypt and were believed to be living gods</span>
                </li>
                <li className="flex items-start text-lg">
                  <span className="mr-3 text-2xl">🔺</span>
                  <span><strong>Pyramids</strong> — Massive stone monuments built as tombs for pharaohs, including the Great Pyramid of Giza</span>
                </li>
                <li className="flex items-start text-lg">
                  <span className="mr-3 text-2xl">📜</span>
                  <span><strong>Hieroglyphics</strong> — The ancient Egyptian writing system using pictures and symbols to tell stories</span>
                </li>
                <li className="flex items-start text-lg">
                  <span className="mr-3 text-2xl">🪦</span>
                  <span><strong>Mummies & The Afterlife</strong> — How Egyptians preserved bodies and prepared for eternal life in the afterworld</span>
                </li>
                <li className="flex items-start text-lg">
                  <span className="mr-3 text-2xl">⚡</span>
                  <span><strong>Gods & Goddesses</strong> — The powerful deities that Egyptians worshipped and believed controlled their world</span>
                </li>
              </ul>
            </div>

            <div>
              <h3 className="font-bangers text-2xl text-ancient-brown mb-4 tracking-wide">Fun Facts About Ancient Egypt:</h3>
              <ul className="space-y-3 list-none pl-0">
                <li className="flex items-start text-lg">
                  <span className="mr-3">✨</span>
                  <span>The Great Pyramid of Giza was the tallest man-made structure in the world for over 3,800 years!</span>
                </li>
                <li className="flex items-start text-lg">
                  <span className="mr-3">✨</span>
                  <span>Ancient Egyptians invented toothpaste and used it to clean their teeth, just like we do today.</span>
                </li>
                <li className="flex items-start text-lg">
                  <span className="mr-3">✨</span>
                  <span>The Nile River flooded every year, which was essential for farming and growing food in the desert.</span>
                </li>
                <li className="flex items-start text-lg">
                  <span className="mr-3">✨</span>
                  <span>Cleopatra, one of Egypt's most famous rulers, was actually Greek, not Egyptian!</span>
                </li>
              </ul>
            </div>
          </div>
