...
export default function AztecMayaPage() {
  const civilization = timeTravelersData.civilizations.find(c => c.id === 'aztec-maya');
    ...
    <div className="min-h-screen bg-parchment-pattern">
      ...
      <section className="relative pt-24 pb-32 overflow-hidden border-b-4 border-gold/40">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-[hsl(var(--aztec-accent))]/10 mix-blend-overlay" />
        </div>
      ...
      <main className="container max-w-7xl mx-auto px-4 py-16">
        ...
        {filteredFacts.length > 0 ? (
          ...
          <div className="text-center py-24 bg-white/40 rounded-3xl border-2 border-dashed border-gold/40">
            ...
            <p className="text-ancient-brown/70">Try searching for something else like "Pyramid" or "Chocolate".</p>
          </div>
        )}
      </main>
      ...
      <section className="py-20 md:py-28 bg-white/50 backdrop-blur-sm border-t border-gold/20">
        <div className="container max-w-4xl mx-auto px-4">
          <h1 className="font-bangers text-4xl md:text-5xl text-ancient-brown mb-8 tracking-wide">
            Aztec & Maya Civilizations for Kids — Temples, Calendars & Ancient Empires
          </h1>
          
          <div className="prose prose-lg max-w-none text-ancient-brown/80 space-y-6">
            <p className="text-lg leading-relaxed">
              Welcome to the fascinating world of the Aztec and Maya civilizations! Discover two of the most advanced and mysterious cultures of ancient Mesoamerica. From towering pyramids and intricate calendars to incredible art and sophisticated cities, the Aztec and Maya left behind a legacy that continues to amaze us today.
            </p>

            <div>
              <h3 className="font-bangers text-2xl text-ancient-brown mb-4 tracking-wide">What You'll Learn About the Aztec & Maya:</h3>
              <ul className="space-y-3 list-none pl-0">
                <li className="flex items-start text-lg">
                  <span className="mr-3 text-2xl">🏛️</span>
                  <span><strong>Amazing Architecture</strong> — Massive pyramids, temples, and cities built without modern tools or machinery</span>
                </li>
                <li className="flex items-start text-lg">
                  <span className="mr-3 text-2xl">📅</span>
                  <span><strong>Advanced Calendars</strong> — The Maya created incredibly accurate calendars that tracked time and celestial events</span>
                </li>
                <li className="flex items-start text-lg">
                  <span className="mr-3 text-2xl">✍️</span>
                  <span><strong>Writing Systems</strong> — The Maya developed a complex writing system using hieroglyphics to record their history</span>
                </li>
                <li className="flex items-start text-lg">
                  <span className="mr-3 text-2xl">🎨</span>
                  <span><strong>Art & Crafts</strong> — Beautiful pottery, sculptures, murals, and intricate jewelry that showcase their creativity</span>
                </li>
                <li className="flex items-start text-lg">
                  <span className="mr-3 text-2xl">🌽</span>
                  <span><strong>Agriculture & Food</strong> — They cultivated corn, beans, and cacao, and invented chocolate!</span>
                </li>
              </ul>
            </div>

            <div>
              <h3 className="font-bangers text-2xl text-ancient-brown mb-4 tracking-wide">Fun Facts About the Aztec & Maya:</h3>
              <ul className="space-y-3 list-none pl-0">
                <li className="flex items-start text-lg">
                  <span className="mr-3">✨</span>
                  <span>The Aztec capital, Tenochtitlan, was built on an island in a lake and was one of the largest cities in the world at that time!</span>
                </li>
                <li className="flex items-start text-lg">
                  <span className="mr-3">✨</span>
                  <span>The Maya invented the number zero centuries before Europeans knew about it — a major mathematical breakthrough!</span>
                </li>
                <li className="flex items-start text-lg">
                  <span className="mr-3">✨</span>
                  <span>Chocolate was sacred to the Aztecs and Maya. They believed it was a gift from the gods and used it in ceremonies.</span>
                </li>
                <li className="flex items-start text-lg">
                  <span className="mr-3">✨</span>
                  <span>The Maya mysteriously abandoned their great cities around 900 AD, but their descendants still live in Mexico and Central America today.</span>
                </li>
              </ul>
            </div>
          </div>
